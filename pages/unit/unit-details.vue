          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="work-left work-details" data-aos="fade-up">
              <div class="portfolio-main-info">
                <h2 class="title">TENTANG TKK ST. MARIA SIDOARJO</h2>

                <div class="work-details-list mt-40">
                  <div class="details-list">
                    <label>Berdiri</label>
                    <span>16 Juli 1989</span>
                  </div>
                  ...
                  <div class="details-list">
                    ...
                    <li>Lomba Tari Juara 1 tingkat TK</li>
        ...
        <div class="row mt-60">
          <div class="col-lg-4 col-md-12 col-12">
            <div class="digital-marketing" data-aos="fade-up">
              <h3 class="heading heading-h3">TKK St. Maria Sidoarjo</h3>
            </div>
          </div>
          ...
          <div class="row mtn-30">
            <div class="col-lg-6 col-md-6 col-12 mt-30">
              <div class="thumbnail" data-aos="fade-up">
                <img
                  class="w-100"
                  src="/images/project/unit-details-1.png"
                  alt="Agency"
                />
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12 mt-30">
              <div class="thumbnail" data-aos="fade-up">
                <img
                  class="w-100"
                  src="/images/project/unit-details-2.png"
                  alt="Agency"
                />
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-30">
              <div class="thumbnail" data-aos="fade-up">
                <img
                  class="w-100"
                  src="/images/project/unit-details-5.png"
                  alt="Agency"
                />
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-30">
              <div class="thumbnail" data-aos="fade-up">
                <img
                  class="w-100"
                  src="/images/project/unit-details-6.png"
                  alt="Agency"
                />
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-30">
              <div class="thumbnail" data-aos="fade-up">
                <img
                  class="w-100"
                  src="/images/project/unit-details-7.png"
                  alt="Agency"
                />
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-12 mt-30">
              <div class="thumbnail" data-aos="fade-up">
                <img
                  class="w-100"
                  src="/images/project/unit-details-8.png"
                  alt="Agency"
                />
              </div>
            </div>
